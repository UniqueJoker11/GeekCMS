...
public abstract class DaoEngine implements ISupportDao {
	...
	// 日志记录器
	protected Logger logger =  LoggerFactory.getLogger("daoEngine");
	...
	// 查询对象
	public Integer queryForObject(String sql, Class<Integer> clzz){
		logger(sql);
		return jdbcTemplate.queryForObject(sql, clzz); 
	}
